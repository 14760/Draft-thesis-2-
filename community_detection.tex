...
The Newman and Girvan algorithm (Newman and Girvan, 2004) calculates the betweenness
...
to reduce the network to. An implementation is provided in igraph and it generates a dendrogram of heirarchical clustering communities with the optimum division being the one that maximises modulatity. This algorithm was used by Pocklington et al. (2006a) to find
...
8.2.2 Spectral methods using the modularity matrix
